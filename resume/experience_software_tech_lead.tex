      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Achievements:}
          \begin{itemize}
            ...
            % Team 6 month Roadmap, clearly defined stories{objective, stakeholder, value proposition etc}, frequent(almost daily deploy(when it is done I am shipping it))
